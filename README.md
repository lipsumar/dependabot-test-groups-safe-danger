...
This repo is a copy of `dependabot-test`, but with a `dependabot.yml` file added, including groups. We're trying multiple groups: a "safe" group for patch/minor and a "danger" group for majors.
